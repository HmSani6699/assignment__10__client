    ...
    return (
        <div className='w-2/4 mx-auto mt-10 mb-14'>
            <Pdf targetRef={ref} filename="code-example.pdf">
                {({ toPdf }) => <div className='flex justify-center items-center mt-3 mb-8'>
                <button className='border border-red-500 px-6 py-2 rounded-3xl  ' onClick={toPdf}>
                    <div className='flex items-center justify-center gap-3'>
                        <FaFilePdf className=' text-red-600'></FaFilePdf>
                        Generate Pdf
                    </div>
                </button>
                    </div>}
                    ...
                    <div className='p-10'>
                        ...
                        <blockquote className='ps-5 mt-4'>
                            <p>To validate React props using PropTypes, you can use the PropTypes package, which is included with React.
                                ...
                                If a prop is passed to the component that does not match its expected type, a warning will be logged in the console. This can be very helpful for catching bugs early on in the development process. It's important to note that PropTypes are not enforced in production mode, so it's still important to handle unexpected prop types gracefully in your code.</p>
